...
struct tadlexer_le_t_ {
	enum {
		HTTP_TADLEXER_LE_STATE_START,
		HTTP_TADLEXER_LE_STATE_FIRST_BYTE,
		HTTP_TADLEXER_LE_STATE_SEGLEN_FIRST,
		HTTP_TADLEXER_LE_STATE_SEGLEN_SECOND,
		HTTP_TADLEXER_LE_STATE_LSEGLEN_FIRST,
		HTTP_TADLEXER_LE_STATE_LSEGLEN_SECOND,
		HTTP_TADLEXER_LE_STATE_LSEGLEN_THIRD,
		HTTP_TADLEXER_LE_STATE_LSEGLEN_FORTH,
		HTTP_TADLEXER_LE_STATE_DATA,
	} state;
	UB segid;
	UW len;
	UW len_read;
